...
<style>
    *{
    ...
    body{
        background-image: url("../images/lapbg3.jpg");
...
<button id="back"><a href="adminlaptop.php">HOME</a></button> 
 ...
 <div class="main">
        ...
        <div class="register">
        <h2>Enter Details Of New Laptop</h2>
        <form id="register"  action="upload.php" method="POST" enctype="multipart/form-data">    
            ...
            id="name" placeholder="Enter laptop Name" required>
            <br><br>

            <label>Company : </label>
            <br>
            <input type ="text" name="company"
            id="name" placeholder="Enter company" required>
            <br><br>

            <label>RAM : </label>
            <br>
            <input type="number" name="ram"
            id="name" placeholder="Enter size Of RAM" required>
            <br><br>

            <label>PROCESSOR : </label>
            <br>
            <input type="text" name="processor"
            id="name" placeholder="Enter Processor Details" required>
            <br><br>
            <label>Price : </label>
            <br>
